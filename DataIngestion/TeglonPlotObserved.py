...
class Teglon:
    ...
    def main(self):
        ...
        ax.annotate('50th percentile', xy=(_50_text_x,_50_text_y), xycoords='axes fraction', fontsize=sm_label_size)
        ax.annotate('90th percentile', xy=(_90_text_x,_90_text_y), xycoords='axes fraction', fontsize=sm_label_size)
